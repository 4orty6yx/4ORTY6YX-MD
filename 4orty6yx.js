...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['4ORTY6YX-OFFICIAL-MD', "safari", "1.0.0"],
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '254795900001';
            const dj2 = '254795900001';
            ...
            console.log("\t🌍4ORTY6YX-OFFICIAL-MD ONLINE🌍");
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `*4ORTY6YX-OFFICIAL-MD WELCOME MESSAGE*`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("------------------/-----");
                console.log("4orty6yx Md is Online 🕸\n\n");
